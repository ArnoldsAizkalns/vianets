...
export default function SipPanelPage() {
  return (
    <div className="pt-5 md:pt-20 lg:pt-40 max-w-screen-2xl mx-auto px-4 md:px-6">
      <div className="pb-5">
        <h1 className="text-4xl md:text-[96px] pb-5 md:pb-5">
          Спецпредложения
        </h1>
      </div>
      ...
      >
        ...
        <p className="pt-5 pb-5 text-[20px] font-semibold">
        ...
        <p className="leading-6">
          ...
          3. Подготовку всей необходимой документации для проектирования. <br />
      ...
      <ServiceSection title="Прибыль" subtitle="Для девелоперов и застройщиков">
        ...
        <p className="pt-5 leading-6">
          ...
          <br />
          2. Технология строительства минимизирует «человеческий фактор». <br />
        ...
        <p className="pt-5 leading-6">
          - Доставку домокомплектов на объект. <br />- Подготовку инструкции или
          сборку готового к монтажу домокомплекта. <br />
